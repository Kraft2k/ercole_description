...
def generate_launch_description():
    ...
    ercole_controller = PathJoinSubstitution(
        [
            FindPackageShare("ercole_description"),
            "config",
            "ercole_controllers.yaml",
        ]
    )
    ...
    arguments = [
        DeclareLaunchArgument(
            'controllers_file',
            default_value=['ercole_controllers.yaml'],
    ...
    controller_manager_node = Node(
        ...
        parameters=[robot_description, ercole_controller, use_sim_time_param],
        output={
            "stdout": "screen",
            "stderr": "screen",
        },
